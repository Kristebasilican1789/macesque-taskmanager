...
KCMUtils.SimpleKCM {
    ...
    Kirigami.FormLayout {
        QQC2.ComboBox {
            id: thumbnailMode
            Kirigami.FormData.label: i18nc("@label:listbox", "Show window thumbnails:")
            Layout.fillWidth: true
            Layout.minimumWidth: Kirigami.Units.gridUnit * 14

            model: [
                i18nc("@item:inlistbox which tasks show a window thumbnail", "For minimized windows only"),
                i18nc("@item:inlistbox which tasks show a window thumbnail", "For all windows"),
                i18nc("@item:inlistbox which tasks show a window thumbnail", "For unfocused windows"),
                i18nc("@item:inlistbox which tasks show a window thumbnail", "For windows on other desktops")
            ]
        ...
        Kirigami.InlineMessage {
            Layout.fillWidth: true
            visible: thumbnailMode.currentIndex === 3
            text: i18nc("@info", "Windows from other desktops only appear in the taskbar when “From the current desktop” is unchecked in the Behavior settings.")
        }

        QQC2.ComboBox {
            id: iconAlignment
            Kirigami.FormData.label: i18nc("@label:listbox", "Icon alignment:")
            Layout.fillWidth: true
            Layout.minimumWidth: Kirigami.Units.gridUnit * 14
        ...
        QQC2.ComboBox {
            ...
            model: [
                i18nc("@item:inlistbox how wide a task item should be", "Square"),
